...
/*
Demo 03 - Pre-encoded payload (only)

Goal: Producer encodes payload once, hub fans out shared []byte.
Also adds snapshot replay: hub keeps last payload per topicID and replays on subscribe.
*/
...
func main() {
	...
	log.Println("demo03 listening :8080")
